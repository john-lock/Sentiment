...
class Test(unittest.TestCase):
    ...
    def testScore(self):
        with app.test_client() as client:
            ...
            self.assertIn('Total sentences found:</b> 100\\n            <b>Positive:</b> 23', str(result.data))
    ...
    def testTable(self):
        with app.test_client() as client:
            sent = {'urlInput': 'https://sentiment.johnlock.nl/testpage'}
            result = client.post('/', data=sent)
            self.assertIn('<td>      Starship Mine Stardate: 46682.4 Original Airdate: 29 Mar, 1999', str(result.data))
